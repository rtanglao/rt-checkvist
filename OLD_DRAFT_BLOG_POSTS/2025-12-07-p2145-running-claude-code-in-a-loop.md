---
layout: post
title: "ME:: I wonder how many tokens this will burn :-)  Again nobody talks about the $$$$$ i.e. the costs; Anand Chowdhary:: continuous-claude CLI tool: Running Claude Code in a loop "
---
[Discovered](http://rolandtanglao.com/2020/07/29/p1-blogthis-checkvist-list-links-to-blog/): Dec 8, 2025 05:45 (UTC) [ME:: I wonder how many tokens this will burn :-)  Again nobody talks about the $$$$$ i.e. the costs; Anand Chowdhary:: continuous-claude CLI tool: Running Claude Code in a loop ](https://anandchowdhary.com/blog/2025/running-claude-code-in-a-loop) 
