...
* Read the whole thing: [Mark Sherwood:: Writing Knowledge Base Articles for Humans and AI](https://swifteq.com/post/knowledge-base-articles-humans-ai) 
...
>**The best way to handle all of this, and the [template that ties all](https://swifteq.com/post/knowledge-base-article-templates) of this together starts with an answer-first opening block, followed by a one-line prerequisites statement, then a single procedure per page, with the product and plan named in the first paragraph.**
