---
layout: post
title: "ME:: tl;dr-ing find a good CLAUDE.md for your type of program and  then create a personal ~/.claude/CLAUDE.md for your own coding style Nolan Lawson:: How I use AI agents to write code ¦ Read the Tea Leaves"
---
[Discovered](http://rolandtanglao.com/2020/07/29/p1-blogthis-checkvist-list-links-to-blog/): Jan 24, 2026 23:14 (UTC) [ME:: tl;dr-ing find a good CLAUDE.md for your type of program and  then create a personal ~/.claude/CLAUDE.md for your own coding style Nolan Lawson:: How I use AI agents to write code ¦ Read the Tea Leaves](https://nolanlawson.com/2025/12/22/how-i-use-ai-agents-to-write-code/)
