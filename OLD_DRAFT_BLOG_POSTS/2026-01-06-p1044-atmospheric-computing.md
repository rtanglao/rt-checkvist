---
layout: post
title: "ME:: I want my own personal atmospheric cloud running my own software including 'AI'. It doesn't have to be on my own hardware, could be in a trusted cloud provider(s) ; Paul Frazee:: Atmospheric Computing ¦ Paul's Dev Notes"
---
[Discovered](http://rolandtanglao.com/2020/07/29/p1-blogthis-checkvist-list-links-to-blog/): Jan 6, 2026 18:44 (UTC) [ME:: I want my own personal atmospheric cloud running my own software including 'AI'. It doesn't have to be on my own hardware, could be in a trusted cloud provider(s) ; Paul Frazee:: Atmospheric Computing ¦ Paul's Dev Notes](https://www.pfrazee.com/blog/atmospheric-computing)
